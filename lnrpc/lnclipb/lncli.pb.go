...
// 	protoc        v3.6.1
// source: lnclipb/brolncli.proto

package lnclipb

import (
	verrpc "github.com/brronsuite/broln/lnrpc/verrpc"
...
type VersionResponse struct {
	...
	// The version information for brolncli.
	Brolncli *verrpc.Version `protobuf:"bytes,1,opt,name=brolncli,proto3" json:"brolncli,omitempty"`
...
var file_lnclipb_lncli_proto_depIdxs = []int32{
	1, // 0: lnclipb.VersionResponse.brolncli:type_name -> verrpc.Version
