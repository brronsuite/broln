...
RUN apk add --no-cache --update alpine-sdk \
    ...
    make \
    gcc \
&&  git clone https://github.com/brronsuite/broln /go/src/github.com/brronsuite/broln \
&&  cd /go/src/github.com/brronsuite/broln \
...
COPY --from=builder /go/src/github.com/brronsuite/broln/scripts/verify-install.sh /
COPY --from=builder /go/src/github.com/brronsuite/broln/scripts/keys/* /keys/
