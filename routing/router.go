...
import (
	...
	"github.com/brronsuite/broln/amp"
	"github.com/brronsuite/broln/batch"
	...
	"github.com/brronsuite/broln/lnwallet/chanvalidate"
	"github.com/brronsuite/broln/lnwire"
	"github.com/brronsuite/broln/multimutex"
	"github.com/brronsuite/broln/record"
	"github.com/brronsuite/broln/routing/chainview"
	"github.com/brronsuite/broln/routing/route"
	"github.com/brronsuite/broln/routing/shards"
	"github.com/brronsuite/broln/ticker"
	"github.com/brronsuite/broln/zpay32"
...
func (r *ChannelRouter) networkHandler() {
	...
	//
	// See https://github.com/brronsuite/broln/issues/4892.
...
func (r *ChannelRouter) processUpdate(msg interface{},
	...
	case *channeldb.ChannelEdgeInfo:
		...
		if err != nil {
			...
			//
			// * brond:
			//    * https://github.com/brronsuite/brond/blob/master/rpcserver.go#L1316
			//    * https://github.com/brronsuite/brond/blob/master/rpcserver.go#L1086
			// * brocoind:
