...
[brronsuite](https://github.com/brronsuite)) which is outlined on this page.
...
initial [Lightning Network Specifications](https://github.com/brronsuite/lightning-rfc).
...
- Changes to publicly exported packages such as
  [brontide](https://github.com/brronsuite/broln/tree/master/brontide) should
...
- Changes to behavior within the daemon's interaction with the P2P protocol,
  ...
  [`networkHarness`framework](https://github.com/brronsuite/broln/blob/master/lntest/harness.go)
  contained within `broln`. For example integration tests, see
  [`broln_test.go`](https://github.com/brronsuite/broln/blob/master/broln_test.go#L181). 
...
[perusing the make file documentation](https://github.com/brronsuite/broln/blob/master/docs/MAKEFILE.md).
...
definitions, check out the [lnrpc README](https://github.com/brronsuite/broln/blob/master/lnrpc/README.md).
...
```shell
⛰  go mod edit -replace=github.com/brronsuite/lightning-onion@v0.0.0-20180605012408-ac4d9da8f1d6=github.com/roasbeef/lightning-onion@2e5ae87696046298365ab43bcd1cf3a7a1d69695
```
...
PR](https://github.com/brronsuite/broln/tree/master/docs/release-notes).
...
Rejoice as you will now be listed as a [contributor](https://github.com/brronsuite/broln/graphs/contributors)!
...
[MIT license](https://github.com/brronsuite/broln/blob/master/LICENSE).  This is
...
contribution](https://github.com/brronsuite/brond/blob/master/docs/code_contribution_guidelines.md)
