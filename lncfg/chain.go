...
type Chain struct {
	...
	MinHTLCIn           lnwire.MilliBronees `long:"minhtlc" description:"The smallest HTLC we are willing to accept on our channels, in millibronees"`
	MinHTLCOut          lnwire.MilliBronees `long:"minhtlcout" description:"The smallest HTLC we are willing to send out on our channels, in millibronees"`
	BaseFee             lnwire.MilliBronees `long:"basefee" description:"The base fee in millibronees we will charge for forwarding payments on our channels"`
	FeeRate             lnwire.MilliBronees `long:"feerate" description:"The fee rate used when forwarding payments on our channels. The total fee charged is basefee + (amount * feerate / 1000000), where amount is the forwarded amount."`
