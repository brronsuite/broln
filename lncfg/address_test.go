...
var (
	...
	addressTestVectors = []addressTest{
		{"tcp://127.0.0.1:9782", "tcp", "127.0.0.1:9782", true, false},
		{"tcp:127.0.0.1:9782", "tcp", "127.0.0.1:9782", true, false},
		{"127.0.0.1:9782", "tcp", "127.0.0.1:9782", true, false},
		{":9782", "tcp", ":9782", false, false},
		{"", "tcp", ":1234", false, false},
		{":", "tcp", ":1234", false, false},
		{"tcp4://127.0.0.1:9782", "tcp", "127.0.0.1:9782", true, false},
		{"tcp4:127.0.0.1:9782", "tcp", "127.0.0.1:9782", true, false},
		...
		{
			"4acth47i6kxnvkewtm6q7ib2s3ufpo5sqbsnzjpbi7utijcltosqemad.onion:9782",
			"tcp",
			"4acth47i6kxnvkewtm6q7ib2s3ufpo5sqbsnzjpbi7utijcltosqemad.onion:9782",
			false,
			false,
