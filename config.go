...
import (
	...
	"github.com/brronsuite/broln/htlcswitch/hodl"
...
type Config struct {
	...
	RawExternalIPs    []string `long:"externalip" description:"Add an ip:port to the list of local addresses we claim to listen on to peers. If a port is not specified, the default (9782) will be used regardless of other parameters"`
