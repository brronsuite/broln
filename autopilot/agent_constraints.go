...
type AgentConstraints interface {
	...
	ChannelBudget(chans []LocalChannel, balance bronutil.Amount) (
		bronutil.Amount, uint32)
...
func NewConstraints(minChanSize, maxChanSize bronutil.Amount, chanLimit,
...
func (h *agentConstraints) ChannelBudget(channels []LocalChannel,
	funds bronutil.Amount) (bronutil.Amount, uint32) {
	...
	var totalChanAllocation bronutil.Amount
	...
	targetAllocation := bronutil.Amount(float64(totalFunds) * h.allocation)
...
//
// Note: part of the AgentConstraints interface.
func (h *agentConstraints) MinChanSize() bronutil.Amount {
...
//
// Note: part of the AgentConstraints interface.
func (h *agentConstraints) MaxChanSize() bronutil.Amount {
