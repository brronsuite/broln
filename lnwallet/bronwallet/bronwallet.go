...
func (b *bronwallet) GetRecoveryInfo() (bool, float64, error) {
	...
	// main chain.
	//
	// NOTE: The actual recovery process is handled by the brronsuite/bronwallet.
