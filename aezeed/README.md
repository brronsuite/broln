...
[In this PR](https://github.com/brronsuite/broln/pull/773) we added a new package implementing the aezeed cipher
...
goos: linux
goarch: amd64
pkg: github.com/brronsuite/broln/aezeed
...
PASS
ok      github.com/brronsuite/broln/aezeed  4.168s
```
