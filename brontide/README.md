...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/brronsuite/broln/brontide)
...
detail in [BOLT #8 of the Lightning Network specifications](https://github.com/brronsuite/lightning-rfc/blob/master/08-transport.md).
...
```shell
⛰  go get -u github.com/brronsuite/broln/brontide
```
